<nav x-data="{ open: false }" class="bg-indigo-800 text-white border-b-1 border-gray-600 shadow-lg">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::user()->admin)
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin - appointment')" :active="request()->routeIs('admin-appointment')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @auth
            @if (Auth::user()->admin)
                <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('admin - appointment')" :active="request()->routeIs('appointment-admin')">
            ...
            <div class="flex items-center px-4">
                ...
                <div class="ml-3">
                    ...
                    @guest
                        ...
                        <div class="font-medium text-sm text-gray-500">Unregistered</div>
                    @endguest
                </div>
